...
@section ('contenido') 
  ...
  <div class="row">
    ...
    <div class="col-lg-6">  
        ...
        {!!Form::open(['route'=>'ayudaemail.index', 'method'=>'POST'])!!}
    ...
    <div class="col-lg-6">  
        ...
        <a href="mailto:info@incotec.com.bo"> <input type="text" name="" value="info@incotec.com.bo" style="text-transform: lowercase;" readonly> </a> 
        <br><br>
